            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="{{route('setting.name.index',[1])}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Name
                        </a>
                        <a class="nav-link" href="{{route('setting.list.index', [1])}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Item
                        </a>
                        <div class="sb-sidenav-menu-heading">Orders</div>
                        <a class="nav-link" href="{{ route('entry-header.selection',['operation'=> 1]) }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Create Order
                        </a>
                        <a class="nav-link" href="{{ route('entry-header.selection',['operation'=> 2]) }}">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Update Order
                        </a>
                        <div class="sb-sidenav-menu-heading">Reporting</div>
                        <a class="nav-link" href="{{ route('entry-header.index')}}">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Overview
                        </a>
